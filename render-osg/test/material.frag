...
uniform float unf51;
uniform vec3 unf52;
uniform sampler2DShadow samp1;
uniform mat4 unf56;
const float cons57 = float(0.005000);
const vec4 cons67 = vec4(0.000000, 0.000000, 0.000000, 0.005000);
uniform float unf78;
uniform float unf81;
uniform vec3 unf87;
uniform vec3 unf93;
...
uniform float unf104;
uniform float unf115;
uniform float unf117;
uniform vec3 unf118;
uniform sampler2DShadow samp2;
uniform mat4 unf122;
const float cons123 = float(0.005000);
const vec4 cons133 = vec4(0.000000, 0.000000, 0.000000, 0.005000);
uniform float unf144;
uniform float unf147;
uniform vec3 unf153;
const float cons163 = float(0.171191);
uniform vec4 unf164;
const float cons170 = float(1.000000);
...
void main(void)
{
	...
	shade_mul_value(unf22, vec4(tmp21, 1.0), tmp24);
	set_rgb_zero(tmp25);
	lamp_visibility_other(varposition, unf27, tmp28, tmp29, tmp30);
	lamp_falloff_invsquare(unf31, tmp29, tmp33);
	lamp_visibility_spot_circle(unf34, tmp28, tmp36);
	lamp_visibility_spot(unf37, unf38, tmp36, tmp33, tmp41);
	lamp_visibility_clamp(tmp41, tmp43);
	shade_inp(tmp2, tmp28, tmp46);
	shade_visifac(tmp46, tmp43, unf49, tmp50);
	shade_mul_value_v3(unf51, unf52, tmp53);
	test_shadowbuf(varposition, samp1, unf56, cons57, tmp46, tmp59);
	shade_mul_value(tmp50, vec4(tmp53, 1.0), tmp62);
	mtex_value_invert(tmp59, tmp64);
	mix_mult(tmp64, tmp62, cons67, tmp68);
	mtex_value_invert(tmp64, tmp70);
	shade_madd(tmp24, tmp68, vec4(tmp21, 1.0), tmp74);
	shade_cooktorr_spec(tmp2, tmp28, tmp4, unf78, tmp79);
	shade_spec_t(tmp70, unf81, tmp43, tmp79, tmp84);
	shade_add_spec(tmp84, tmp53, unf87, tmp88);
	shade_add_clamped(vec4(tmp25, 1.0), vec4(tmp88, 1.0), tmp91);
	lamp_visibility_other(varposition, unf93, tmp94, tmp95, tmp96);
	lamp_falloff_invsquare(unf97, tmp95, tmp99);
	lamp_visibility_spot_circle(unf100, tmp94, tmp102);
	lamp_visibility_spot(unf103, unf104, tmp102, tmp99, tmp107);
	lamp_visibility_clamp(tmp107, tmp109);
	shade_inp(tmp2, tmp94, tmp112);
	shade_visifac(tmp112, tmp109, unf115, tmp116);
	shade_mul_value_v3(unf117, unf118, tmp119);
	test_shadowbuf(varposition, samp2, unf122, cons123, tmp112, tmp125);
	shade_mul_value(tmp116, vec4(tmp119, 1.0), tmp128);
	mtex_value_invert(tmp125, tmp130);
	mix_mult(tmp130, tmp128, cons133, tmp134);
	mtex_value_invert(tmp130, tmp136);
	shade_madd(tmp74, tmp134, vec4(tmp21, 1.0), tmp140);
	shade_cooktorr_spec(tmp2, tmp94, tmp4, unf144, tmp145);
	shade_spec_t(tmp136, unf147, tmp109, tmp145, tmp150);
	shade_add_spec(tmp150, tmp119, unf153, tmp154);
	shade_add_clamped(tmp91, vec4(tmp154, 1.0), tmp157);
	shade_clamp_positive(tmp157, tmp159);
	shade_clamp_positive(tmp140, tmp161);
	shade_maddf(tmp161, cons163, unf164, tmp165);
	shade_add(tmp165, tmp159, tmp168);
	mtex_alpha_to_col(tmp168, cons170, tmp171);
	shade_alpha_opaque(tmp171, tmp173);
	linearrgb_to_srgb(tmp173, tmp175);
